...
const CurrentWeather: React.FC<CurrentWeatherProps> = React.memo(({ apiKey, periodicallyRefreshDataInSeconds, theme }: CurrentWeatherProps) => {
    const dispatch = useDispatch();
    const weatherData: WeatherData | null = useSelector((state: RootState) => state.weather.data);
    ...
    const [lastRefreshTime, setLastRefreshTime] = useState(new Date().toTimeString());
    ...
    return (
        <ThemeProvider theme={{ theme }}>
            <Container>
                ...
                {loading ? <Loader color={theme}>Loading...</Loader> : weatherData && <Weather data={weatherData} theme={theme} today={today} />}
